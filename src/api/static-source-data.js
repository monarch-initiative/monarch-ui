  ...
  const staticSourceData = [
    {
      ...
      monarchUsage:
        "We list genotype-phenotype associations and asserted disease-models. We use MGI identifiers as " +
    ...
    },
    {
      ...
      sourceDescription:
        "The Zebrafish Information Resource is the community database resource for the laboratory " +
      ...
      monarchUsage: "",
      vocabulary:
        "We integrate the curated genotype-phenotype data, including experimentally derived fish " +
    ...
    },
    {
      ...
      sourceDescription:
        ...
        "facilitation of the use of zebrafish as a model for human biology.",
      monarchUsage:
        "Zfin model only containing Gene to phenotype associations using this file: https://zfin.org/downloads/phenoGeneCleanData_fish.txt",
      vocabulary: "",
    ...
    },
    {
      ...
      monarchUsage:
        "Wormbase curates variant (allele)-phenotype associations. The variants are both genetic (intrinsic) and induced through application of reagents such as RNAi (extrinsic). We list the variant-phenotype associations. Some data is pulled from WormBase directly, other data is routed via WormMine.",
    ...
    },
    {
      ...
      monarchUsage:
        "We use the allele-phenotype associations recorded by the consortium. In addition, we map their allele+zygosity+background to MGI genotype identifiers. Where they do not map to MGI genotype identifiers, we create temporary identifiers for navigation purposes.",
      vocabulary: "MP",
    ...
    },
    {
      ...
      monarchUsage:
        "We use curated disease-gene, disease-locus, and variant-disease associations, together with their annotated references. Most OMIM diseases are further curated by the HPO group. Most OMIM diseases are integrated into the Disease Ontology.",
      vocabulary: "OMIM",
    ...
    },
    {
      ...
      monarchUsage:
        "We link pertinent cell lines to any diseases for which they are asserted models.",
      vocabulary: "OMIM",
    ...
    },
    {
      ...
      monarchUsage:
        "We integrate the asserted (curated) disease-gene associations, and their evidence.",
    ...
    },
    {
      ...
      monarchUsage:
        "We use the HPO disease-phenotype annotations as the primary atomic description of a disease, and list them on the disease pages, together with their references. The Human Phenotype Ontology is integrated into our cross-species phenotype ontology.",
      vocabulary: "ECO, HPO",
    ...
    },
    {
      ...
      monarchUsage:
        "We list disease-gene associations, and gene-pathway associations. We utilize the KEGG Ortholog (KO) gene-pathway associations, and infer a specific-organisms' participation in that pathway based on the gene-KO links.",
      vocabulary: "MESH, OMIM",
    ...
    },
    {
      ...
      monarchUsage:
        "We use NCBIGene ids and symbols as the primary identifier and label for human genes in our system and NCBITaxon identifiers and scientific name for species-specific labeling. For any given gene, we also list the annotated pmids from Pub2Gene.",
      vocabulary: "",
    ...
    },
    {
      ...
      monarchUsage:
        "Monarch indicates gene-gene/protein-protein interactions on gene pages. We also use many of the id mappings to resolve ids in our own site.",
      vocabulary: "MI",
    ...
    },
    {
      ...
      monarchUsage:
        "Monarch links the variants recorded here to the curated EFO-classes",
    ...
    },
    {
      ...
      monarchUsage:
        "Monarch obtains equivalencies between Ensembl gene IDs and NCBI gene IDs",
      vocabulary: "",
    ...
    },
    {
      ...
      monarchUsage:
        "Monarch processes gene-process/function/subcellular/location associations.",
      vocabulary: "RO",
    ...
    },
    {
      ...
      monarchUsage:
        "Monarch creates equivalences between HGNC identifiers and ENSEMBL and NCBIGene. We also add the links to cytogenic locations for the gene features.",
      vocabulary: "",
    ...
    },
    {
      ...
      monarchUsage:
        "Monarch stores the top 20 ranked tissues where a gene is over expressed based on differential expression measures across evidence lines",
      vocabulary: "Uberon",
    ...
    },
    {
      ...
      monarchUsage:
        "Monarch stores protein protein interactions with a confidence >.7",
      vocabulary: "RO",
    ...
    },
    {
      ...
      sourceDescription:
        "The Rat Genome Database (RGD)is the premier site for genetic, genomic, phenotype, and disease data generated from rat research",
    ...
    },
    {
      ...
      monarchUsage:
        "Monarch stores gene to phenotype associations and gene function data",
      vocabulary: "APO, RO",
    ...
    },
    {
      ...
      monarchUsage:
        "Slim MGI model only containing Gene to phenotype associations. This uses mousemine: " +
    ...
    },
    {
      ...
      sourceDescription:
        "This is the parser for data curated by the Monarch Initiative.",
      monarchUsage: "",
      vocabulary: "",
    ...
    },
    {
      ...
      sourceDescription:
        "Ingested data represents major " +
      ...
      monarchUsage:
        "We leverage the GENO ontology and modeling patterns to build " +
    ...
    },
    {
      ...
      sourceDescription:
        "Chemical and drug annotation data, aggregated from many popular data resources.",
      monarchUsage: "",
      vocabulary: "",
    ...
    // a long time.
    {
      ...
      monarchUsage:
        "disease-gene association, variant-disease association, variant definitions",
      vocabulary: "UMLS",
      sourceFiles: [
        {
          fileUrl:
      ...
      ingestDate: "",
      rdfDownloadUrl:
        "https://archive.monarchinitiative.org/latest/rdf/clinvar.nt",
    },
    {
      ...
      monarchUsage:
        "Monarch stores phenotypes for each case and variants of interest",
      vocabulary: "RO",
      ...
      ingestDate: "",
      rdfDownloadUrl:
        "https://archive.monarchinitiative.org/latest/rdf/udp.ttl",
    },
  ];

  // convert to hash map for easier lookup when merging with dynamic data
  const staticSourceDataHashMap = staticSourceData.reduce(function fn(
    map,
    obj
  ) {
