...
<div class="container-fluid monarch-view monarch-licensing offset-1 col-10">
    ...
    <h4>Ontologies</h4>
    <p>Monarch maintains several ontologies, and uses several more. Licensing and other information about these
        ontologies is <a href="/about/ontologies">here</a>.</p>
