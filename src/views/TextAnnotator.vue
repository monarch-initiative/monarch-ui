                                ...
                                <div class="content">
                                        <div class="step1" v-if="!resultsStep">
                                            ...
                                            <b-link @click="populateExample">
                                                <i class="fa fa-arrow-circle-down" aria-hidden="true"></i> Try example
                                            </b-link>
                                            <br>
                                            <b-form-textarea
                                                    id="textarea"
                                        ...
                                        <div class="step2" v-if="resultsStep">
                                            <div class="step2" ref="step2text" v-html="annotatedText"></div>
                                        </div>
            ...
            annotatedText(val){
                if(val){
                    ...
                    this.$nextTick(()=>{
                        ...
                        child.addEventListener('mouseleave', function(elem) {
                            const annotation = elem.target;
                            const popover = annotation.children[0];
