  ...
  <div class="container-fluid monarch-view">
    <div class="row">
      <div class="offset-2 col-8 text-center">
        ...
        <p>
          This Phenotype Profile Search enables you to find phenotypically
          similar diseases or genes in a variety of organisms, then visualize
          their overlap. Begin by constructing a "profile" (a collection of
          phenotypes) then create a comparison profile.
        </p>
      </div>
    </div>
      ...
      <div class="col-10 card card-body step-1">
        <div v-if="currentStep === 1">
          <b-button
            ...
            @click="goBack()"
          >
            <i class="fa fa-chevron-left edit-comparison" aria-hidden="true" />
            Go Back
          </b-button>
          <b-button
            v-b-modal.help-one
            ...
            variant="info"
          >
            <i class="fa fa-info-circle edit-comparison" aria-hidden="true" />
            Help
          </b-button>
          ...
          <div v-if="currentSubStep === 2">
            ...
            >
              Error: '{{ rejectedPhenotypeCuries }}' Please ensure your list is
              comma seperated and the id's are valid
              <a target="_blank" href="https://hpo.jax.org">HPO</a> id's.
            </b-alert>
          </div>
          ...
          <div v-if="currentSubStep === 4">
            ...
            />
            <small
              >*Non-phenotype entities will automatically be mapped to their
    ...
    <div
      v-if="(currentStep === 2 || currentStep === 3) && !showPhenogrid"
      class="row py-2"
    >
      <div class="col-1" />
      <div class="col-10 card card-body">
          ...
          <div v-if="!comparisonCategory" class="center-text">
            <b-form-group>
              <b-button-group>
                <b-button
                  variant="outline-info"
                  @click="comparisonCategory = 'everything'"
                >
                  Show me everything
                </b-button>
                <b-button
                  variant="outline-info"
                  @click="comparisonCategory = 'custom'"
                >
        ...
        <div v-if="comparisonCategory === 'everything'" class="center-text">
          <b-form-group>
            <b-button-group>
              <b-button
                variant="outline-info"
                @click="everythingCategory = 'everything-genes'"
              >
                all matching genes
              </b-button>
              <b-button
                variant="outline-info"
                @click="everythingCategory = 'everything-diseases'"
              >
        ...
        <div
          v-if="
            everythingCategory === 'everything-genes' &&
            comparisonCategory === 'everything'
          "
          class="center-text"
        >
          <b-form-select
            v-model="selectedGeneGroup"
            class="gene-group-select"
            :options="targetGeneGroups"
          />
        </div>
        <div v-if="comparisonCategory === 'custom'" class="text-center">
          <b-button-group>
            ...
            <b-button
              variant="outline-info"
              @click="customCategory = 'disease'"
            >
              a specific disease
            </b-button>
            <b-button
              variant="outline-info"
              @click="customCategory = 'phenotypes'"
            >
          ...
          <div v-if="phenotypeComparison.length > 0" class="flex-container">
            ...
            >
              ...
              <i
                ...
                aria-hidden="true"
              />
              &nbsp;Comparison Phenotype Profile (
              {{ phenotypeComparison.length }} phenotypes )
            </b-button>
            <b-collapse
              id="collapse-phenotypes"
              v-model="showComparisonCollapse"
              class="flex-container"
            >
              <div
    ...
    <b-modal id="help-one" size="xl" title="Creating Starting Profile" ok-only>
      <p>
        To begin, you can create a profile by pasting a list of phenotypes (<a
          href="https://hpo.jax.org"
          target="_blank"
          >Human Phenotype Ontology</a
        >) and confirming your profile.
      </p>
      ...
      <br />
      <p>
        As an alternative you can build a profile of phenotypes by choosing a
        gene or disease. The associated phenotypes to those entities will be
        populated for you.
      </p>
      <div class="text-center">
    ...
    >
      ...
      <p>
        You may choose to conduct a blanket search by selecting either all genes
        from a single species or all human diseases. Once you make a selection,
        you may run the analysis.
      </p>
      <div class="text-center">
      ...
      <br />
      <p>
        For a more fine grained search, you can again build a profile by
        selecting a specific disease or gene, as well as pasting another list of
        phenotypes. Finally, you can run the analysis.
      </p>
      <div class="text-center">
...
export default {
  ...
  methods: {
    ...
    determineFinished() {
      ...
      return (
        this.geneCustomPathValid() ||
        this.diseaseCustomPathValid() ||
        this.phenotypePathValid() ||
        this.everythingPathGenesValid() ||
    ...
    everythingPathGenesValid() {
      return (
        this.comparisonCategory === "everything" &&
        this.everythingCategory === "everything-genes" &&
        this.selectedGeneGroup != null
      );
    },
    everythingPathDiseasesValid() {
      return (
        this.comparisonCategory === "everything" &&
        this.everythingCategory === "everything-diseases"
      );
    },
    diseaseCustomPathValid() {
      return (
        this.comparisonCategory === "custom" &&
        this.customCategory === "disease" &&
    ...
    phenotypePathValid() {
      return (
        this.comparisonCategory === "custom" &&
        this.customCategory === "phenotypes" &&
        this.phenotypeComparison.length > 0
      );
    },
    ...
    async fetchPhenotypes(curie, nodeIdentifier) {
      ...
      try {
        ...
        searchResponse.data.associations.forEach((elem) => {
          if (
            categoryRef === "phenotypes" &&
            !elem.object.id.startsWith("EFO")
          ) {
