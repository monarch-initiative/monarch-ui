...
export default
{
  "animalqtldb": {
    ...
    "horseQTL": "https://www.animalgenome.org/cgi-bin/QTLdb/EC/qdetails?QTL_ID=[reference]",
    "cattleQTL": "https://www.animalgenome.org/cgi-bin/QTLdb/BT/qdetails?QTL_ID=[reference]",
    "catfishQTL": "https://www.animalgenome.org/cgi-bin/QTLdb/IP/qdetails?QTL_ID=[reference]",
    "chickenQTL": "https://www.animalgenome.org/cgi-bin/QTLdb/GG/qdetails?QTL_ID=[reference]",
    "pigQTL": "https://www.animalgenome.org/cgi-bin/QTLdb/SS/qdetails?QTL_ID=[reference]",
    "rainbow_troutQTL": "https://www.animalgenome.org/cgi-bin/QTLdb/OM/qdetails?QTL_ID=[reference]",
    "sheepQTL": "https://www.animalgenome.org/cgi-bin/QTLdb/OA/qdetails?QTL_ID=[reference]",
    "AQTLPub": "https://www.animalgenome.org/cgi-bin/QTLdb/BT/qabstract?PUBMED_ID=[reference]"
  },
  "bfo": {
  ...
  "go": {
    ...
    "GO_REF": "http://www.geneontology.org/cgi-bin/references.cgi#GO_REF:[reference]",
    "PAINT_REF": "http://www.geneontology.org/gene-associations/submission/paint/[reference]"
  },
  "hpoa": {
  ...
  "mpd": {
    ...
    "MPD-assay": "https://phenome.jax.org/db/qp?rtn=views/catlines&keymeas=[reference]",
    "MPD-strain": "http://phenome.jax.org/db/q?rtn=strains/details&strainid=[reference]"
  },
  "pmid": {
  ...
  "aspgd_ref": {
    "AspGD_REF": "http://www.aspergillusgenome.org/cgi-bin/reference/reference.pl?dbid=[reference]"
  },
  "apo": {
  ...
  "coriell": {
    "Coriell": "https://catalog.coriell.org/0/Sections/Search/Sample_Detail.aspx?Ref=[reference]",
    "CoriellCollection": "https://catalog.coriell.org/1/[reference]",
    "CoriellFamily": "https://catalog.coriell.org/0/Sections/BrowseCatalog/FamilyTypeSubDetail.aspx?fam=[reference]",
    "CoriellIndividual": "https://catalog.coriell.org/Search?q=[reference]"
  },
  "dbsnpindividual": {
    "dbSNPIndividual": "http://www.ncbi.nlm.nih.gov/SNP/snp_ind.cgi?ind_id=[reference]"
  },
  "emma": {
  ...
  "mugen": {
    "MUGEN": "http://bioit.fleming.gr/mugen/Controller?workflow=ViewModel&expand_all=true&name_begins=model.block&eid=[reference]"
  },
  "ncimr": {
  ...
  "panther": {
    "PANTHER": "http://www.pantherdb.org/panther/family.do?clsAccession=[reference]"
  },
  "clinvar": {
    "ClinVar": "http://www.ncbi.nlm.nih.gov/clinvar/[reference]",
    "ClinVarVariant": "http://www.ncbi.nlm.nih.gov/clinvar/variation/[reference]",
    "ClinVarSubmitters": "http://www.ncbi.nlm.nih.gov/clinvar/submitters/[reference]"
  },
  "cosmic": {
    "COSMIC": "http://cancer.sanger.ac.uk/cosmic/mutation/overview?id=[reference]"
  },
  "hgmd": {
    "HGMD": "http://www.hgmd.cf.ac.uk/ac/gene.php?gene=[reference]"
  },
  "dbsnp": {
    "dbSNP": "http://www.ncbi.nlm.nih.gov/projects/SNP/snp_ref.cgi?rs=[reference]"
  },
  "dbvar": {
  ...
  "genatlas": {
    "Genatlas": "http://genatlas.medecine.univ-paris5.fr/fiche.php?symbol=[reference]"
  },
  "genbank": {
  ...
  "rgd": {
    ...
    "RGDRef": "http://rgd.mcw.edu/rgdweb/report/reference/main.html?id=[reference]"
  },
  "sgd": {
  ...
  "xenbase": {
    "Xenbase": "http://www.xenbase.org/gene/showgene.do?method=display&geneId=[reference]"
  },
  "zfin": {
  ...
  "iuphar": {
    "IUPHAR": "http://www.guidetopharmacology.org/GRAC/ObjectDisplayForward?objectId=[reference]"
  },
  "cid": {
