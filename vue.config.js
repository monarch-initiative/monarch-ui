...
const GenomeFeatureViewer = path.resolve(
  __dirname,
  "node_modules/genomefeaturecomponent/src/index.js"
);
const GenomeFeatureViewerCSS = path.resolve(
  __dirname,
  "node_modules/genomefeaturecomponent/src/GenomeFeatureViewer.css"
);
...
const vueConfig = {
  ...
  chainWebpack: (config) => {
    ...
    config.resolveLoader.modules.add(path.resolve("./src/loaders/"));
    config.module
      .rule("README")
      .test(/\.md$/)
      .include.add(path.resolve("./README.md"))
      .end()
      .use("vue-loader")
      .loader("vue-loader")
      .end()
    ...
    config.module
      .rule("CONTRIBUTING")
      .test(/\.md$/)
      .include.add(path.resolve("./CONTRIBUTING.md"))
      .end()
      .use("vue-loader")
      .loader("vue-loader")
      .end()
